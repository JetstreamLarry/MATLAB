% Return the eigenvalues, internal stability, natural modes and time constants of an LTI system given its A matrix.

function [eigs, intStab, natMode, timeCons] = intStab(A)
    syms t;
    intStab = "Asymptotically Stable";
    minMultZero = 0;
    natMode = zeros(1, size(A));
    timeCons = zeros(1, size(A));
